                ...
                <table class="table table-striped table-bordered table-hover" id="tb-detail">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center {{ $purchaseorder->purchasestatus->name == 'ongoing' ? 'hidden' : null }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center {{ $purchaseorder->purchasestatus->name == 'ongoing' ? 'hidden' : null }}">
    ...
    $(function () {
        ...
        var tb_detail = $('#tb-detail').DataTable({
            ...
            createdRow: function (row, data, index) {
                ...
                $('td', row).eq(1).addClass('name').attr('contentEditable', {{ $purchaseorder->purchasestatus->name == 'create' ? 'true' : 'false' }});
                $('td', row).eq(2).addClass('text-center number').attr('contentEditable', {{ $purchaseorder->purchasestatus->name == 'create' ? 'true' : 'false' }});
                $('td', row).eq(3).addClass('text-center {{ $purchaseorder->purchasestatus->name == 'ongoing' ? 'hidden' : null }}');
            },
